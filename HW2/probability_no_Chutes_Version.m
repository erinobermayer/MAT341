function probability_no_Chutes_Version()
    N = 500000;      %N is the number of times we play the game
    ctVec = zeros(200,1);  %this vector will keep track of the frequency of each number of turns it took to win
    for i = 1:N
        playGame = no_Chutes_Version();     %play the game and get the number of turns it took
    ...
    ylabel('Probability')
    title('Probability Distribution for No Chutes Version')       %title the graph
end